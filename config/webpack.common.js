...
var app_branch;
var app_name;
if (fs.existsSync(info_paths.version)) {
    app_version = fs.readFileSync(info_paths.version, 'utf8').toString()
}

if (fs.existsSync(info_paths.branch)) {
    app_branch = fs.readFileSync(info_paths.branch, 'utf8').toString().trim().toUpperCase();
}


app_name = 'Viadialog App'
