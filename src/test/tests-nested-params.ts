...
export function TestNestedParams() {
  ...
  describe('Nested params', () => {
    ...
    it('should retrieve pairs value/key for rest query params', () => {
      let pattern = 'http://something.com/book/:bookId/author/:author';
    ...
    it('should retrieve pairs value/key for rest query params 3 level', () => {
    ...
    it('should retrieve pairs value/key for rest query params 3 level other case', () => {
      let title = 'aaasdasd'
    ...
    it('should check if url not contains models ', () => {
    ...
    it('should check if url contains models with dash ', () => {
