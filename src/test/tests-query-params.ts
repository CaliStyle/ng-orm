...
export function TestQueryParams() {
  ...
  describe('Query params', () => {
    ...
    it('Should transform url params from array', () => {
    ...
    it('Should transform url params from one object', () => {
      let res = Rest.getParamsUrl([
    ...
    it('Should not put undefined in query param', () => {
      let res = Rest.getParamsUrl([
    ...
    it('Should decode params for string', () => {
    ...
    it('Should transform url param into query string with object', () => {
      let p = '?super=%7B%22name%22%3A%22Dariusz%22%7D';
