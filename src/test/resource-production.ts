...
export class TestProduction {
  ...
  constructor() {
    ...
    it('It should throw error when no mock in MOCK_ONLY mode',
      ...
      inject([Resource, Http, MockBackend, Jsonp],
        (rest: Resource<APIS, User, User[]>, http: Http, backend: MockBackend, jp: Jsonp) => {
          ...
          }).toThrow('In MOCKING MODE you have to define mock of query for endpoint: https://somewhere.com/users.');
